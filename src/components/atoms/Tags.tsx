...
import { IPostType, ISector, ITag } from '../../utils/AxiosApiServiceLogin'
import { cn } from '../../utils'
// Định nghĩa Interface cho Tag

// Component để hiển thị danh sách các tag
const TagList: React.FC<{ tags: ITag[] | ISector[] | IPostType[] }> = ({ tags }) => {
...
interface AProps {
  tags: ITag[] | ISector[] | IPostType[] // Nhận dữ liệu tags từ props
  className?: string
}

const Tags: React.FC<AProps> = ({ tags = [], className }) => {
  if (tags as IPostType) {
    // return <TagList tags={[types]} />
  }
